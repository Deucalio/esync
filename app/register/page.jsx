        ...
        <li>
          <form class="grid border-teal-700 text-sm" action="">
            <ul class="">
              ...
              <li class="mt-4">
                <p>Already have an account? <span class="cursor-pointer font-semibold text-indigo-500 transition-all hover:text-indigo-700 hover:underline">Sign in</span></p>
              </li>
            </ul>
          </form>
        </li>
            ...
            <ul class="">
              ...
              <li class="flex flex-col gap-1">
                ...
                <div class="flex flex-row items-center justify-center gap-3">
                  ...
                  <button class="mt-4 h-10 w-24 rounded-md bg-blue-900 text-xs transition-all duration-500 hover:bg-blue-950">Resend</button>
                </div>

                <button class="mx-auto mt-10 w-32 px-3 py-2 rounded-md bg-gradient-to-l from-indigo-600 to-violet-700  hover:bg-indigo-800 hover:from-indigo-700 hover:to-violet-800">Register</button>
              </li>
            </ul>
          </form>
        </li>
